...
const QUICK_PROMPTS = [
  ...
  "CEO အနေနဲ့ company culture ကို ဘယ်လို တည်ဆောက်ရမလဲ?",
  "Series A funding ကို ဘယ်လို ပြင်ဆင်ရမလဲ?",
            ...
            <div className="flex items-center gap-1 sm:gap-2 flex-wrap sm:justify-end sm:flex-shrink-0">
              ...
              {(user as any)?.businessName && (
                <div className="hidden md:flex items-center gap-1.5 px-2 sm:px-2.5 py-1 rounded-lg text-xs"
                  style={{ background: "oklch(65% 0.2 280 / 0.08)", border: "1px solid oklch(65% 0.2 280 / 0.2)", color: "oklch(65% 0.03 220)" }}>
              ...
              {isUnlimited ? (
                ...
                <div className="flex items-center gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs font-semibold"
                  style={{ background: "oklch(75% 0.18 55 / 0.08)", border: "1px solid oklch(75% 0.18 55 / 0.2)", color: "oklch(80% 0.18 55)" }}>
              ...
              <div className="flex gap-3">
                ...
                <div className="px-4 py-3 rounded-2xl" style={{ background: "oklch(18% 0.05 220)", border: "1px solid oklch(25% 0.04 220)" }}>
                  <div className="flex gap-1.5">
                    {[0,1,2].map(n => <div key={n} className="w-2 h-2 rounded-full animate-bounce" style={{ background: "oklch(75% 0.18 55)", animationDelay: `${n*0.15}s` }} />)}
                  </div>
                </div>
              </div>
            )}
