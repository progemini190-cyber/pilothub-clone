...
type GoogleSignInButtonProps = {
  /** Additional Tailwind classes (e.g. w-full). */
  className?: string;
  /** Compact style for nav bars. */
  ...
  return (
    <a
      ...
      className={cn(
        ...
        "hover:bg-zinc-50 hover:ring-zinc-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950",
        isCompact ? "px-3 py-2 text-sm" : "w-full px-4 py-3 text-[15px]",
        className,
      )}
    >
      <GoogleGMark className={isCompact ? "h-[18px] w-[18px]" : "h-5 w-5"} />
